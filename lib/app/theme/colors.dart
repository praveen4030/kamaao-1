...
Map<int, Color> textColor = {
  ...
  300: const Color(0xFF14142B),
  400: const Color(0xFF14142B),
  500: const Color(0xFF14142B),
  600: const Color(0xFF14142B),
  700: const Color(0xFF14142B),
  800: const Color(0xFF14142B),
  900: const Color(0xFF14142B),
};
...
class Kolors {
  ...
  static Color redColor = const Color(0xFFEA4335);
  static Color blueColor = const Color(0xFF2196F3);
  static Color greyColor = const Color(0xFF707070);
  static Color greenColor = const Color(0xFF61D239);
  static Color greenActiveJobColor = const Color(0xFF34A853);
  ...
  static const Color seperatorHighlight = Color(0xffE78353);
  static const Color integrfaceInputBg = Color(0xffFFF9F6);
  static const Color disabledButton = Color(0xffE5DFDC);
  ...
  static Color backgroundAccent = const Color(0xffFFEFEF);
  static const Color backgroundInterfaceColor = Color(0xffE5DFDC);
  static Color backgroundActionColor = const Color(0xFFFA6F2C);
  static Color backgroundLight = const Color(0xFFFFE8DC);
